...
public:
    ...
    /*
     * @brief Gets the position of the char in the _validCharacters
     * Query method
     * @return a int with the position of the char
    */
    int findChar(char bigram_character) const;
...
private:
    ...
    // m�todos privados para la gestion de memoria
    int** allocate();
    void deallocate(int ** ptr);
    void copyMatrix(const BigramCounter &to_copy);
};
